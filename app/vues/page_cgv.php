<section>
    <article>
        ...
        <p>Les CGV définissent les droits et obligations des parties dans le cadre de la vente de produits par AY-Lab aux clients du site.</p>

        <h2>Article 2 : Produits</h2>
        <p>Les produits proposés à la vente sont ceux qui figurent sur le site, dans la limite des stocks disponibles. Chaque produit est accompagné d'un descriptif établi par AY-Lab.</p>

        <h2>Article 3 : Prix</h2>
        <p>Les prix des produits sont indiqués en euros toutes taxes comprises. AY-Lab se réserve le droit de modifier ses prix à tout moment.</p>
        ...
        <p>AY-Lab ne saurait être tenue responsable des dommages indirects subis par le client.</p>
